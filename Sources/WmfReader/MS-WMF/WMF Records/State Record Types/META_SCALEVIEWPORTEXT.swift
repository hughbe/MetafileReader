...
/// [MS-WMF] 2.3.5.12 META_SCALEVIEWPORTEXT Record
/// The META_SCALEVIEWPORTEXT Record scales the horizontal and vertical extents of the viewport that is defined in the playback
/// device context by using the ratios formed by the specified multiplicands and divisors.
/// See section 2.3.5 for the specification of other State Record Types.
public struct META_SCALEVIEWPORTEXT {
