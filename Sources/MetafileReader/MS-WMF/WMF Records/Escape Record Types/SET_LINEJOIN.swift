...
/// [MS-WMF] 2.3.6.41 SET_LINEJOIN Record
/// The SET_LINEJOIN Record specifies the type of line-joining to use in subsequent graphics operations.
/// See section 2.3.6 for the specification of other Escape Record Types.
public struct SET_LINEJOIN {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// (SET_LINEJOIN) from the MetafileEscapes Enumeration (section 2.1.1.17) table.
